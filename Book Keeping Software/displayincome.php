        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown"id="home">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item active" aria-current="page" href="displayincome.php">Income Statement</a></li>
...
<div class="container">
    <div class="row justfy-content-center my-5 mx-0">
        ...
        <h2 id="formheading">INCOME STATEMENT REPORT </h2>
        <center><hr id="headinghr"></center>
        </div>
