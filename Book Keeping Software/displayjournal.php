        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown"id="home">
                ...
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item active" aria-current="page" href="displayjournal.php" >Journal Entry</a></li>
...
<div class="container">
    <div class="row justfy-content-center my-5 mx-0">
        ...
        <h2 id="formheading">JOURNAL ENTRY REPORT </h2>
        <center><hr id="headinghr"></center>
        </div>
        <?php
$id=$_SESSION["BusinessId"];
$jour=mysqli_query($conn,"SELECT * FROM journal WHERE BusinessId='$id'");
if (mysqli_num_rows($jour) > 0) {
    // output data of each row
    ?>
    ...
    <?php
    while($res = mysqli_fetch_assoc($jour)) {
        ?>
        <tr>
                        <td><?php echo $res['Dates'];?></td>
                        <td><?php echo $res['DAccount'];?><br>&nbsp;&nbsp;&nbsp;<?php echo $res['CAccount'];?></td>
                        <td><?php echo $res['Amount'];?></td>
                        <td><br><?php echo $res['Amount'];?></td>
    ...
    <tr>
          <?php
          $sum=mysqli_query($conn,"SELECT SUM(Amount) AS Total FROM journal WHERE BusinessId='$id'");
          $ro = mysqli_fetch_assoc($sum);
          $total = $ro["Total"];
          ?>
          <td><b>Total</b></td>
          <td></td>
          <td><b><u><?php echo $total;?></b></u></td>
    ...
    echo "No Record In Journal Entry";
  }
    ?>
    </table></center>
        </div>
